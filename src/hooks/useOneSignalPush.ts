 ...
 *
 * - Native (Despia) : fire-and-forget via setonesignalplayerid + registerpush
    ...
    const init = async () => {
      try {
        if (isNativeApp()) {
          ...
          // Doc: https://github.com/despia-native/despia-native (README)
 ...
 *
 * - Native (Despia) : dissocie le device du user via setonesignalplayerid vide
